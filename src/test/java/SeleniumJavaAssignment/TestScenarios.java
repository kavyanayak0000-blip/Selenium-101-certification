...
public class TestScenarios extends BaseClass{
	...
	public void simpleFormDemo() {
		...
		getDriver().findElement(By.linkText("Simple Form Demo")).isDisplayed();
		getDriver().findElement(By.linkText("Simple Form Demo")).click();

		//3. Validate that the URL contains “simple-form-demo”
		Assert.assertTrue(getDriver().getCurrentUrl().contains("simple-form-demo"), "URL does not contain 'simple-form-demo'");

		//4. Create a variable for a string value, e.g., “Welcome to LambdaTest”.
		String inputTxt = "Welcome to TestMu AI";

		//5. Use this variable to enter values in the “Enter Message” text box.
		getDriver().findElement(By.id("user-message")).clear();
		getDriver().findElement(By.id("user-message")).sendKeys(inputTxt);

		//6. Click “Get Checked Value”.
		getDriver().findElement(By.xpath("//button[@id='showInput']")).isDisplayed();
		getDriver().findElement(By.xpath("//button[@id='showInput']")).click();
		...
		WebElement outputText = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[text()='Welcome to TestMu AI']")));
	...
	public void fromDemo() {
		...
		WebElement submitBttn = getDriver().findElement(By.xpath("(//button[@type='submit'])[2]"));
		submitBttn.click();

		//3. Assert “Please fill out this field.” error message.
		WebElement nameField = getDriver().findElement(By.id("name"));
		String validationMessage = 
				(String) ((org.openqa.selenium.JavascriptExecutor) getDriver()).executeScript("return arguments[0].validationMessage;", nameField);
		Assert.assertEquals(validationMessage, "Please fill out this field.");

		//4. Fill in Name, Email, and other fields.
		getDriver().findElement(By.name("name")).sendKeys("John");
		getDriver().findElement(By.id("inputEmail4")).sendKeys("johndoe14@mail.com");
		getDriver().findElement(By.id("inputPassword4")).sendKeys("Password@12345");
		getDriver().findElement(By.name("company")).sendKeys("ABC Org");
		getDriver().findElement(By.xpath("//input[@placeholder='Website']")).sendKeys("www.google.com");

		//5. From the Country drop-down, select “United States” using the text property.
		getDriver().findElement(By.name("country")).click();
		...
		getDriver().findElement(By.name("city")).sendKeys("us");
		getDriver().findElement(By.id("inputAddress1")).sendKeys("address 1");
		getDriver().findElement(By.id("inputAddress2")).sendKeys("address 2");
		getDriver().findElement(By.xpath("//input[@placeholder='State']")).sendKeys("united state");
		getDriver().findElement(By.name("zip")).sendKeys("441133");
		submitBttn.click();
